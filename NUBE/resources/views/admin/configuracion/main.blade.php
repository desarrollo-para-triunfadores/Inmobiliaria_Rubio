                        ...
                        <div class="row">                           
                            ...
                            <div class="col-sm-2">
                                <div class="text-right">
                                    <button title="Editar la información asociada a la empresa" type="button" id="boton-modal-conf" class="btn btn-sm btn-warning" data-toggle="modal" data-target="#modal-guardar-conf">                                       
